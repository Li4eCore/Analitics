...
└── 02_data-model/           # Связи, ключи, кардинальность, фильтрация, USERELATIONSHIP
README.md
```
...
- [Модель данных: связи, кардинальность, фильтрация](power-bi-learning/02_data-model/02_data_model.md)
